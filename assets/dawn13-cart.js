    ...
    fetch(`${routes.cart_change_url}`, { ...fetchConfig(), ...{ body } })
      ...
      .then((state) => {
        ...
        if(document.querySelector('.cart-drawer-call-expert-phone') && window.chosen_expert != undefined){
          ...
          expertButton.innerHTML = `TESTING TESTING Click to call ${window.chosen_expert.name} <span style="white-space:nowrap;">${window.chosen_expert.phone}</span>`
        }
      ...
      .catch(() => {
        console.log('In the cart.js catch block')
