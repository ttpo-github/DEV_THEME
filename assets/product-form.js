  ...
  customElements.define('product-form', class ProductForm extends HTMLElement {
    ...
    onSubmitHandler(evt) {
      ...
      if(disclaimerCheck.required && !disclaimerCheck.checked){
        this.handleErrorMessage("Please read and confirm details below");
        return;
      }
      ...
      this.querySelector('.main-atc-spinner').classList.remove('hidden');
      ...
      fetch(`${routes.cart_add_url}`, config)
        ...
        .finally(() => {
          ...
          this.querySelector('.main-atc-spinner').classList.add('hidden');
        });
    }
    ...
    handleErrorMessage(errorMessage = false) {
      ...
      if (errorMessage) {
        ...
        this.errorMessage.scrollIntoView({block: 'center'});
      } 
    }
  });
}
